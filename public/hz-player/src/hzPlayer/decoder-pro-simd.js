!(function(e, t) {
  ...
  var v = b(function(z) {
      ...
      (_ = void 0 !== (_ = void 0 !== _ ? _ : {}) ? _ : {}).locateFile = function(e) {
        return "decoder-pro-simd.wasm" == e && "undefined" != typeof JESSIBUCA_PRO_SIMD_WASM_URL && "" != JESSIBUCA_PRO_SIMD_WASM_URL
      ...
      var S = {
          ...
          createNode: function(e, t, r, i) {
            ...
            S.ops_table ||
              (S.ops_table = {
                ...
                link: { node: { getattr: S.node_ops.getattr, setattr: S.node_ops.setattr, readlink: S.node_ops.readlink }, stream: {} },
                chrdev: { node: { getattr: S.node_ops.getattr, setattr: S.node_ops.setattr }, stream: E.chrdev_stream_ops }
              });
            r = E.createNode(e, t, r, i);
            return (
              E.isDir(r.mode)
                ? ((r.node_ops = S.ops_table.dir.node), (r.stream_ops = S.ops_table.dir.stream), (r.contents = {}))
                : E.isFile(r.mode)
                ? ((r.node_ops = S.ops_table.file.node), (r.stream_ops = S.ops_table.file.stream), (r.usedBytes = 0), (r.contents = null))
                : E.isLink(r.mode)
                ? ((r.node_ops = S.ops_table.link.node), (r.stream_ops = S.ops_table.link.stream))
                : E.isChrdev(r.mode) && ((r.node_ops = S.ops_table.chrdev.node), (r.stream_ops = S.ops_table.chrdev.stream)),
          ...
          stream_ops: {
            ...
            write: function(e, t, r, i, n, s) {
              ...
              if ((S.expandFileStorage(a, n + i), a.contents.subarray && t.subarray)) a.contents.set(t.subarray(r, r + i), n);
        ...
        E = {
          ...
          lookupPath: function(e) {
            ...
            if (8 < (t = Object.assign({ follow_mount: !0, recurse_count: 0 }, t)).recurse_count) throw new E.ErrnoError(32);
            for (
              ...
              if (a && t.parent) break;
              if (
                ((i = E.lookupNode(i, r[s])),
                (n = v.join2(n, r[s])),
                !E.isMountpoint(i) || (a && !t.follow_mount) || (i = i.mounted.root),
                !a || t.follow)
              )
          ...
          nodePermissions: (e, t) =>
            E.ignorePermissions || ((!t.includes("r") || 292 & e.mode) && (!t.includes("w") || 146 & e.mode) && (!t.includes("x") || 73 & e.mode))
              ? 0
              : 2,
          mayLookup: e => {
          ...
          mayOpen: (e, t) =>
            e
              ? E.isLink(e.mode)
                ? 32
                : E.isDir(e.mode) && ("r" !== E.flagsToPermissionString(t) || 512 & t)
                ? 31
          ...
          nextfd: function() {
            for (
              var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
                t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : E.MAX_OPEN_FDS,
                r = e;
              r <= t;
              r++
            )
          ...
          syncfs: (t, r) => {
            "function" == typeof t && ((r = t), (t = !1)),
              E.syncFSRequests++,
              1 < E.syncFSRequests && o("warning: " + E.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
          ...
          open: (e, t, r) => {
            ...
            if (
              ((r = void 0 === r ? 438 : r),
              (r = 64 & (t = "string" == typeof t ? E.modeStringToFlags(t) : t) ? (4095 & r) | 32768 : 0),
              "object" == typeof e)
            )
              i = e;
            else {
            ...
            return (
              ...
              !_.logReadFiles || 1 & t || (E.readFiles || (E.readFiles = {}), e in E.readFiles || (E.readFiles[e] = 1)),
              r
            );
          },
          close: e => {
          ...
          createDefaultDevices: () => {
            E.mkdir("/dev"),
              E.registerDevice(E.makedev(1, 3), { read: () => 0, write: (e, t, r, i, n) => i }),
              E.mkdev("/dev/null", E.makedev(1, 3)),
              i.register(E.makedev(5, 0), i.default_tty_ops),
              i.register(E.makedev(6, 0), i.default_tty1_ops),
          ...
          createStandardStreams: () => {
            _.stdin ? E.createDevice("/dev", "stdin", _.stdin) : E.symlink("/dev/tty", "/dev/stdin"),
              _.stdout ? E.createDevice("/dev", "stdout", null, _.stdout) : E.symlink("/dev/tty", "/dev/stdout"),
              _.stderr ? E.createDevice("/dev", "stderr", null, _.stderr) : E.symlink("/dev/tty1", "/dev/stderr"),
              E.open("/dev/stdin", 0),
              E.open("/dev/stdout", 1),
              E.open("/dev/stderr", 1);
          },
          ...
          createLazyFile: (e, t, a, r, i) => {
                    ...
                    (void 0 === s.chunks[e] &&
                      (s.chunks[e] = ((e, t) => {
                        ...
                        if (
                          ...
                          return void 0 !== r.response ? new Uint8Array(r.response || []) : ce(r.responseText || "", !0);
            ...
            return (
              ...
              (l.read = (e, t, r, i, n) => (E.forceLoadFile(o), d(e, t, r, i, n))),
              (l.mmap = (e, t, r, i, n) => {
                E.forceLoadFile(o);
                var s = me(t);
              ...
              "string" == typeof e
                ? ((u = o),
                  ...
                  m(
                    t,
                    e => {
                      Y(e, 'Loading data file "' + t + '" failed (no arrayBuffer).'), c(new Uint8Array(e)), f && le();
                    },
                    e => {
      ...
      function Oe(e, t) {
        ...
        if (((i = Me(t.$$.ptr, n, this.registeredClass)), this.isSmartPointer))
      ...
      function I(e, t, r, i, n, s, a, o, l, d, h) {
        (this.name = e),
          ...
          n || void 0 !== t.baseClass ? (this.toWireType = Oe) : ((this.toWireType = i ? Ne : Ge), (this.destructorFunction = null));
      }
      var Ve = [];
      function $e(e) {
        var t = Ve[e];
      ...
      var P = {
        toValue: e => (e || k("Cannot use deleted val. handle = " + e), n[e].value),
        toHandle: e => {
          switch (e) {
            case void 0:
              return 1;
      ...
      (ge = _t),
        (T = _.BindingError = we(Error, "BindingError")),
        (Se = _.InternalError = we(Error, "InternalError")),
        ...
        (_.flushPendingDeletes = Fe),
        (_.setDelayFunction = function(e) {
          (Ie = e), Ce.length && Ie && Ie(Fe);
        }),
        ...
        (I.prototype.readValueFromPointer = He),
        ...
        (I.prototype.fromWireType = function(e) {
          ...
          function r() {
            return this.isSmartPointer
              ? Pe(this.registeredClass.instancePrototype, { ptrType: this.pointeeType, ptr: t, smartPtrType: this, smartPtr: e })
          ...
          return null === n
            ? r.call(this)
            : this.isSmartPointer
            ? Pe(i.registeredClass.instancePrototype, { ptrType: i, ptr: n, smartPtrType: this, smartPtr: e })
            : Pe(i.registeredClass.instancePrototype, { ptrType: i, ptr: n });
        }),
        (je = _.UnboundTypeError = we(Error, "UnboundTypeError")),
      ...
      var yt = {
          ...
          l: function(l, e, t, d, r, h, i, u, n, f, p, s, c) {
            ...
            (r = m),
              ...
              Ue([l, e, t], d ? [d] : [], function(e) {
                ...
                var t,
                  ...
                  s = ((i.prototype = n), new Re(p, i, n, c, a, h, u, f)),
                  e = new I(p, s, !0, !1, !1),
                  a = new I(p + "*", s, !1, !1, !1),
                  o = new I(p + " const*", s, !1, !0, !1);
                return (
                  (ke[l] = { pointerType: a, constPointerType: o }),
                  (t = m),
                  (i = i),
              ...
              Ue([], [e], function(t) {
                ...
                return (
                  void 0 === n || (void 0 === n.overloadTable && n.className !== t.name && n.argCount === a - 2)
                    ...
                    : (ze(i, s, r), (i[s].overloadTable[a - 2] = e)),
                  Ue([], h, function(e) {
                    e = Ze(r, e, t, o, l);
          ...
          e: function(e, t) {
            var r = (function(e, t) {
                for (var r = new Array(e), i = 0; i < e; ++i) r[i] = ut(p[(t + 4 * i) >> 2], "parameter " + i);
                return r;
              })(e, t),
              t = r[0],
              i =
            ...
            var t = Xe(Function, s).apply(null, a),
              u = ht.length;
            return ht.push(t), (ft[i] = n = u);
          },
          s: function(e) {
            4 < e && (n[e].refcount += 1);
          },
          ...
          t: function(e, t) {
            e = (e = ut(e, "_emval_take_value")).readValueFromPointer(t);
            return P.toHandle(e);
          },
          a: function() {
            b("");
        ...
        L =
          (!(function() {
            ...
            if ((oe(), _.instantiateWasm))
              try {
                return _.instantiateWasm(t, r);
              } catch (t) {
                return o("Module.instantiateWasm callback failed with error: " + t);
              }
            s || "function" != typeof WebAssembly.instantiateStreaming || de(c) || he(c) || $ || "function" != typeof fetch
              ? n(i)
      ...
      if (
        ...
        (_._ff_h264_cabac_tables = 217036),
        (ae = function e() {
          St || xt(), St || (ae = e);
        }),
        _.preInit)
  ...
  var te = (g, e) => {
    ...
    function a(e, t) {
      ...
      (i = t),
        ...
        (m = s[1]),
        (s = s[2]),
        Math.abs(u - c) < E && Math.abs(f - m) < E && Math.abs(n - s) < E
          ? C(i)
          : ((s = n - s),
    ...
    constructor(s) {
      (this.log = function(e) {
        ...
        (this.warn = function(e) {
          if (s._opt.debug && (s._opt.debugLevel == w || s._opt.debugLevel == S)) {
            for (var t = s._opt.debugUuid ? `[${s._opt.debugUuid}]` : "", r = arguments.length, i = new Array(1 < r ? r - 1 : 0), n = 1; n < r; n++)
              i[n - 1] = arguments[n];
            console.log(`JbPro${t}:[❗❗❗][${e}]`, ...i);
          }
  ...
  class D {
      ...
      let p = 0,
        ...
        E =
          (r.readBool() &&
            ...
            r.readBool() && ((A = r.readBits(32)), (B = r.readBits(32)), (v = r.readBool()), (w = B), (S = 2 * A), (b = w / S))),
          1),
        U = ((1 === g && 1 === y) || (E = g / y), 0),
        x = 0;
    ...
    static parseSPS$2(e) {
      ...
      let y = 0,
        ...
        v = 0,
        w = 0,
        S = (n.readBool() && ((y = n.readUEG()), (b = n.readUEG()), (v = n.readUEG()), (w = n.readUEG())), 1),
        E = 1,
        U = 0,
        x = !0,
        B = 0,
        ...
        T =
          (n.readBool() &&
            (n.readBool() &&
              (0 < (I = n.readByte()) && I < 16
                ? ((S = [1, 12, 10, 16, 40, 24, 20, 32, 80, 18, 15, 64, 160, 4, 3, 2][I - 1]),
                  (E = [1, 11, 11, 11, 33, 11, 11, 11, 33, 11, 11, 33, 99, 3, 2, 1][I - 1]))
                : 255 === I && ((S = (n.readByte() << 8) | n.readByte()), (E = (n.readByte() << 8) | n.readByte()))),
  ...
  var ee = b(function(e, t) {
    ...
    (B.prototype.setSegmentOptions = function(e, t, r) {
      ...
      (B.prototype.buildTrakSampleLists = function(e) {
        var t, r, i, n, s, a, o, l, d, h, u, f, p, c, m, _, g, y, b, v, w, S, E, U;
        if (
          ((e.samples = []),
          ...
          for (t = 0; t < n.sample_sizes.length; t++) {
            ...
            (x.number = t),
              ...
              o
                ? (t == o.sample_numbers[S] - 1 ? ((x.is_sync = !0), S++) : ((x.is_sync = !1), (x.degradation_priority = 0)),
                  d && d.entries[E].sample_delta + U == t + 1 && ((x.subsamples = d.entries[E].subsamples), (U += d.entries[E].sample_delta), E++))
                : (x.is_sync = !0),
              B.process_sdtp(e.mdia.minf.stbl.sdtp, x, x.number),
              (x.degradation_priority = f ? f.priority[t] : 0),
              d && d.entries[E].sample_delta + U == t && ((x.subsamples = d.entries[E].subsamples), (U += d.entries[E].sample_delta)),
    ...
    }
    {
      ...
      if (0 !== i) return u.map(e => (1 === (e = e.toString(16)).length ? "0" + e : e)).join("");
      {
        ...
        for (let e = 0, t = y.length; e < t; e++)
          240 <= y[e] && y[e] <= 247
            ? (E.push(String.fromCodePoint(((7 & y[e]) << 18) + ((63 & y[e + 1]) << 12) + ((63 & y[e + 2]) << 6) + (63 & y[e + 3]))), (e += 3))
            : 224 <= y[e] && y[e] <= 239
            ? (E.push(String.fromCodePoint(((15 & y[e]) << 12) + ((63 & y[e + 1]) << 6) + (63 & y[e + 2]))), (e += 2))
            : 192 <= y[e] && y[e] <= 223
            ? (E.push(String.fromCodePoint(((31 & y[e]) << 6) + (63 & y[e + 1]))), e++)
            : E.push(String.fromCodePoint(y[e]));
        return E.join("");
      }
    }
  }
          ...
          D = {
              ...
              if (K(n)) postMessage({ cmd: "videoPayload", payload: t, isIFrame: r, ts: e, cts: i }, [t.buffer]);
                ...
                if ((m = !m && r ? !0 : m)) {
                  if (r && D.isVideoSequenceHeader(t)) {
                    const n = 15 & t[0];
                    let e = {};
                    7 == n ? (e = Ee(t.slice(5))) : 12 == n && (e = ke(t)),
                      e.codecWidth &&
                        e.codecHeight &&
                        f &&
                        p &&
            ...
            pcmData: function(n, s, a) {
              if (D.isDestroyed) D.debug.log("worker", "pcmData, decoder is destroyed and return");
                ...
                if (E) {
                  if (!(t >= (s = i - E)))
                    return (E += t), (d[0] = Float32Array.of(...d[0], ...r[0])), void (2 == U && (d[1] = Float32Array.of(...d[1], ...r[1])));
            ...
            errorInfo: function(e) {
              ...
              var t,
                ...
                n = r - w;
              D.debug.log("worker", "errorInfo()", "iframeIntervalTimestamp is", S, "diff is ", n, "max diff is ", i, "wasm decode error:", e.desc),
